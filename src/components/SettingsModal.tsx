...
export const SettingsModal = ({ onClose, user, categories, onSaveCategories, density, onDensityChange, sessionTimeout, onSessionTimeoutChange, notificationAdvance, onNotificationAdvanceChange, onOpenChangelog }: any) => {
